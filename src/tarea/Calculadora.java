...
// Método para la declaración
  static final public double Statement() throws ParseException {double result;
...
// Método para identificadores
  static final public void Identifier() throws ParseException {Token t;
...
// Método para el factor
  static final public double Factor() throws ParseException {Token t = null;
    double result;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:{
...
if (Math.abs(result - 90) < 1e-10) {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x1f200,0x60,0x60,0x180,0x180,0x1f200,};
	}
